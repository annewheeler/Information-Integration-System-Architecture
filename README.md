...
🛠️ Gestiunea Datelor (Data Engineering Lifecycle)Pentru a simula un scenariu real de integrare, am descompus setul de date IBM HR Analytics din formatul original CSV în patru surse eterogene:
- SQL (PostgreSQL): Date de identitate și profil ale angajaților.
- SQL (Oracle): Date financiare și performanță.
- NoSQL (MongoDB): Feedback calitativ sub formă de documente JSON.
- Documente (Excel): Nomenclator de referință pentru departamente și locații.
